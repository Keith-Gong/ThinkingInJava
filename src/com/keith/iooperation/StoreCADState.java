...
class Line extends Shape {
    ...
    public static void serializeStaticState(ObjectOutputStream out) throws Exception {
        out.writeInt(color);
    }
    public static void deserializeStaticState(ObjectInputStream in) throws Exception {
        color = in.readInt();
    }
}